"""Add progress tracking columns to user_bookmarks table
...
def upgrade():
    # add progress tracking columns to user_bookmarks table
    # use batch_alter_table for mysql compatibility
...
def downgrade():
    # remove progress tracking columns from user_bookmarks table
    with op.batch_alter_table('user_bookmarks', schema=None) as batch_op:
