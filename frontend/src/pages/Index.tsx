        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-foreground">LipRead AI</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6">
              ...
              <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent"> AI Power</span>
            </h1>
          ...
          {/* Demo Accounts Info */}
          <div className="bg-card/60 backdrop-blur-sm border border-border rounded-lg p-6 max-w-md mx-auto">
            <h3 className="font-semibold mb-3 text-foreground">Try Demo Accounts</h3>
